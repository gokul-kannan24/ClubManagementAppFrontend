...
const Posts = ({
  ...
  const fetchComments = async () => {
    try {
      const response = await fetch(
        `http://localhost:3000/user/comment/getComments/${id}`,
        {
          headers: {
  ...
  async function addComment() {
    ...
    try {
      const response = await fetch(
        `http://localhost:3000/user/comment/addComment/${id}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleLike = async () => {
    ...
    try {
      const response = await fetch("http://localhost:3000/user/userLike", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const handleSavePost = async () => {
    ...
    try {
      const response = await fetch("http://localhost:3000/user/saveUserPost", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          authorization: `bearer ${JSON.parse(localStorage.getItem("token"))}`,
